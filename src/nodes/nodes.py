...
class VideoMetadataNode:
    ...
    def add_metadata(self, filenames, artist="", comment="", lora_json="", overwrite_original="No"):
        """
        Update metadata in a video file using ffprobe/ffmpeg, appending to existing metadata.
...
"""
Copy of nodes/nodes.py used in src/ layout for packaging.
This file is a literal copy and should be kept in sync with root nodes package.
"""
