...
JoyCaptionMediaDescribe node, LLMStudioMediaDescribe node, and related functionality for configuring media analysis.
"""
...
__all__ = ['GeminiUtilOptions', 'MediaDescribe', 'MediaDescribeOverrides', 'JoyCaptionMediaDescribe', 'LLMStudioMediaDescribe']
