...
class ScribbleLoaderError(RuntimeError):
    """Raised when the scribble model cannot be loaded."""
...
def get_scribble_model(
    ...
    """
    Load a scribble generator from disk (with caching).
    """
...
def clear_scribble_cache():
    """Utility used by tests to clear the cached models."""
